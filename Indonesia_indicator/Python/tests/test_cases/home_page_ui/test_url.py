...
def test_user_will_redirect_to_homepage_if_url_nonexist(browser_driver):
    driver = browser_driver
    home = Home_page(driver)
    navigate_url(home, home.url+"oeoew")
    driver.fullscreen_window()
    assert is_url_same(home, home.url)
    # ytb_video_btn = get_element(home, home.ytb_play_btn, 'youtube video play button')

def test_user_can_navigate_to_existing_url(browser_driver):
    driver = browser_driver
    home = Home_page(driver)
    navigate_url(home, "https://indonesiaindicator.com/who-we-are")
    driver.fullscreen_window()
    assert is_url_same(home, 'https://indonesiaindicator.com/who-we-are')
